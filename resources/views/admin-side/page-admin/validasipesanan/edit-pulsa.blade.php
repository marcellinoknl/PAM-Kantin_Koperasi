...
<html lang="en">
    <head>
        ...
        <title>Vaalidasi Pembelian Pulsa</title>
    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item active">Edit Status Persetujaun Pembelian Pulsa</li>
            </ol>

            <form action="{{ route('pulsa.ubah', $update->id) }}" method="post"
                  ...
                  <div class="col">
                    <div class="form-outline">
                        ...
                        <select class="form-control" aria-label="Default select example" name="status">
                            <option selected disabled>Pilih Validasi Pembelian</option>
