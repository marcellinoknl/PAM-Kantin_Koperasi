...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            ...
            <p style="color:red">*Anda mengubah data</p>
            <form action="{{ route('ruangan.ubah', $update->id) }}" method="post"
                ...
                <div class="row mb-4">
                  <div class="col">
                    <div class="form-outline">
                      ...
                      name="nama_ruangan" value="{{$update->nama_ruangan}}"/>
                  ...
                  <div class="col">
                    <div class="form-outline">
                      ...
                      name="keterangan" value="{{$update->keterangan}}"/>
                          @error('keterangan')
                          <div class="invalid-feedback">
                              {{ $message }}
                          </div>
